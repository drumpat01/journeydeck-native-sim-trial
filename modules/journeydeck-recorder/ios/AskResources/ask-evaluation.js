...
(function (root) {
  ...
  function fixture() {
    ...
    return { now: new Date(2026, 8, 18, 12).getTime(), cutoff: 0, journeys,
      ...
      markers: [{ id: 'k1', journeyId: 'j4', capturedAt: at(16, 19), photos: 2, voiceMemos: 1 },
        { id: 'k2', journeyId: 'j5', capturedAt: at(17), photos: 1, voiceMemos: 0 },
        { id: 'k3', journeyId: 'j6', capturedAt: at(18, 5), photos: 0, voiceMemos: 1 }],
  ...
  const groups = [
    ...
    [{ domain: 'markers', metric: 'voiceMemos' }, 2, ['How many voice memos attached to markers?', 'Count my saved marker voice memos.', 'Total voice memos on completed journey markers?', 'What is my marker voice memo count?']],
  ...
  function grade(id, raw) {
    ...
    const answer = engine.execute(raw, fixture(), null);
